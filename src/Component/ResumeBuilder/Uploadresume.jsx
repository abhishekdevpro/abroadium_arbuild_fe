  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (
        ...
        !response.data.data[0].resume_parse_data
      ) {
          ...
          <div className="h-screen">
            ...
            <div className="flex text-center justify-center gap-10">
              <div className="my-10 p-16 border-dashed border-2 rounded-md border-blue-400">
                <img
                  ...
                  className="ms-24"
                />
                <h1 className="font-bold text-xl mt-2 mb-3 text-slate-700">
                ...
                <label
                  htmlFor="file-upload"
                  className="cursor-pointer text-white px-4 rounded-full py-1 text-xs"
                  style={{ backgroundColor: "#022B5F" }}
                >
                  Browse
                </label>
              </div>
            ...
            <div className="text-center">
              <h3 className="text-xs">
                <strong>Files we can read: PDF</strong>
              </h3>
            </div>
            <div className="text-center mt-10">
              <button
                className="px-10 rounded-full py-2 text-lg text-violet-950 font-bold border border-violet-950"
