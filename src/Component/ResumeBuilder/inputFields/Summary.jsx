            ...
            <div className="m-2 px-10 flex gap-3 w-3/">
              <div>
                ...
                <div className="my-4 mb-10 font-normal">
                  Write 2-5 Sentences that highlight the value you can provide
                  to a team and organization. Mention your previous role,
                  experience & most importantly - your biggest achievements,
                ...
                <ReactQuill
                  ...
                  onChange={(content) =>
                    handleInputChange(
                      {
                        target: { value: content, name: "summarydescription" },
                      },
                      index,
                      "summary"
                    )
