...
const Slider = ({
  ...
  return (
    <div
      className=" w-[203vh] h-16  justify-center px-4"
      style={{ backgroundColor: "#002a48", color: "#F2931C" }}
    >
      <div className=" flex">
        <Link to="/dashboard">
          <div className=" mt-4">
        ...
        <div className="flex justify-around text-xl w-full items-center align-middle space-x-4 ">
          {sections.map((section, index) => (
            <div
              key={index}
              className="flex gap-2 items-center justify-center align-middle"
            >
              <div
              ...
              <div
                className={`cursor-pointer flex text-xl justify-center items-center align-middle px-3 font-semibold  mt-2 ${
                  currentStep === index
                    ? "font-bold text-white shadow-md border-2 py-1 rounded-lg border-green-500 text-xl"
                    : " hover:text-gray-300 hover:rounded-md hover:border-b-4 hover:border-b-gray-500 text-gray-400"
                }`}
                onClick={() => setCurrentStep(index)}
              >
                {section}
