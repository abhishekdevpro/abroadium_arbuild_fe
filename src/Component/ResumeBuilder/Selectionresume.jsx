  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div
            className="flex  justify-between  p-2 h-14 "
            ...
            <div className="md:flex px-3 text-center justify-center md:gap-10">
              <button onClick={handleClick2}>
                <div className=" my-10 p-10 px-16 border rounded-md border-gray-400">
                  <img
                    ...
                    className="ms-28"
                  />
                  <h1 className="font-bold text-lg mb-2 text-slate-700">
                    Yes, upload from my resume
                  </h1>
                  <h6 className="text-xs ">
                    We'll give you expert guidance to fill out your info <br />{" "}
                    and enchance your resume, from start to finish
                  </h6>
                </div>
              </button>
              <button onClick={handleClick}>
                <div className=" my-20 p-10 border rounded-md border-gray-400">
                  ...
                  <h6 className="text-xs ">
                    We'll give you guide you through the whole process so your{" "}
                    <br /> skill can be shine
                  </h6>
                </div>
              </button>
            </div>
