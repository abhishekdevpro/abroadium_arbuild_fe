...
const PreviewSection = ({
  ...
  const resumeScore = async () => {
    try {
      ...
      const requestBody = {
        keyword:
          "Rate this resume content in percentage ? and checklist of scope improvments in manner of content and informations",
        file_location:
  ...
  const updateResume = async () => {
    ...
    const skillsFromApiArray = Array.isArray(skillsfromapi)
      ? skillsfromapi
      : [];
    ...
    const payload = {
      templateData: {
        ...
        details: {
          ...
          languages:
            formData.languages?.map(
              (language) =>
                `${language.Languagename1} ${language.Languagename2}`
            ) || [],
        ...
        skills:
          [
            ...skillsFromApiArray,
            ...(formData.skills?.map((skill) => skill.skillname) || []),
          ] || [],
        education:
        ...
        other_sections:
          formData.sectionadd?.map((section) => ({
        ...
        <div className="py-9 w-1/4">
            ...
            {accuracyPercentage !== null ? (
              <div className="api-data-container border-amber-600 border-4 py-4 ms-3">
                ...
                <p className="font-semibold ms-5">
                  Your AI Score is Percentage: {accuracyPercentage}
                </p>
              </div>
            ) : (
              <button
          ...
          <div className="additional-sections ">
            {formData.sectionadd.map((section, index) => (
              <div
                key={index}
                className="additional-section ms-5 mb-2 border-2 rounded p-2"
              >
                <div className="flex gap-1">
                  <div className="w-3/4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleSectionInputChange(e, index, "sectionadd")
                      }
                ...
                <div className="flex justify-end mt-2">
                  <button
                    className="font-bold text-lg flex items-center p-2 px-2 ms-5 border-2 border-black rounded"
            ...
            <button
              className="font-bold text-lg flex items-center p-2 px- ms-5 border-2 border-black rounded"
