          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full text-center">
            ...
            <div className="space-x-4">
              <button
                ...
                className="bg-orange-600 text-white py-2 px-6 rounded-md hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors"
              >
                Login
              </button>
              <button
