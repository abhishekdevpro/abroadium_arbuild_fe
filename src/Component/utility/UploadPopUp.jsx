...
const ResumeUploadForm = ({ isOpen, onClose }) => {
  ...
  const onSubmit = (data) => {
    ...
    setReferenceFiles([]);
    onClose();
    window.location.href = 'https://builder.abroadium.com/payment';
          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full text-center">
            ...
            <div className="space-x-4">
              <button
                ...
                className="bg-orange-500 text-white py-2 px-6 rounded-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors"
              >
                Login
              </button>
              <button
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100"
                  required
                />
              </div>
              {files.length > 0 && (
