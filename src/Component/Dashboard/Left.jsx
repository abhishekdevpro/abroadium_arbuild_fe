...
function Left() {
  ...
  return (
    <div className="hidden md:flex md:flex-col md:w-[23%] md:justify-start md:p-5 bg-white">
          ...
          {navItems.map((item) => (
              ...
              className={`
                ...
                ${
                  activeTab === item.path
                    ...
                    : "text-black hover:bg-success/50 hover:text-white"
                }
              `}
            ...
            >
              <i
                ...
                ${activeTab === item.path ? "text-primary/90" : ""}
              `}
              ></i>
