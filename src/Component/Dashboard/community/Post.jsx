...
//         <div className="flex">
//           <img src={post.user_photo ? `https://api.abroadium.com/${post.user_photo}` : "https://static.vecteezy.com/system/resources/thumbnails/000/439/863/small/Basic_Ui__28186_29.jpg"} alt="Profile" className="w-10 h-10 rounded-full mr-3 object-cover " />
//           <div>
...
//       )}
//       {post.feed_image && <img src={`https://api.abroadium.com${post.feed_image}`} alt="Post" className="w-full rounded-md mb-4 object-cover max-h-96 " />}
